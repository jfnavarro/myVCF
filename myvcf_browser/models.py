...
class Merged(models.Model):
    ...
    christine = models.TextField(db_column='Christine', blank=True, null=True)  # Field name made lowercase.
    grandma = models.TextField(db_column='Grandma', blank=True, null=True)  # Field name made lowercase.
    grandpa = models.TextField(db_column='Grandpa', blank=True, null=True)  # Field name made lowercase.
    jj = models.TextField(db_column='JJ', blank=True, null=True)  # Field name made lowercase.
    kira = models.TextField(db_column='Kira', blank=True, null=True)  # Field name made lowercase.
